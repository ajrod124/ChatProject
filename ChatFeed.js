...
(function() {
  var ChatFeed, ChatInput, Header, React, ReactNative, ScrollView, ServerContent, ServerSettings, StyleSheet, Text, TextElement, TouchableHighlight, View, WhiteboardContainer, bar, moment, styles, urls;
  ...
  ChatFeed = React.createClass({displayName: "ChatFeed",
          ...
          switch (obj.type) {
            ...
            case 'paintEvent':
              if (_this.whiteboard != null) {
                return _this.whiteboard.paintRemote(obj);
              }
              break;
            default:
    ...
    getWhiteboard: function() {
      if (this.props.whiteboard) {
        return React.createElement(WhiteboardContainer, {
          "ref": ((function(_this) {
            return function(ref) {
    ...
    render: function() {
      ...
      }), this.getWhiteboard(), React.createElement(ScrollView, {
        "ref": ((function(_this) {
          return function(ref) {
